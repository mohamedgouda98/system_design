 ...
 */
        ...
        *::after {
        ...
        .dash-main-content > div:not(:first-child),
        .edit-website > div:not(:first-child),
        .edit-blog > div:not(:first-child) {
            display: none;
        }
        ...
        <footer class="py-4 bg-light mt-auto">
            <div class="container-fluid">
                <div class="d-flex align-items-center justify-content-between small">
                    <div class="text-muted">Copyright &copy; <a href="#"> SHA ACADEMY</a> 2020</div>
                </div>
            </div>
        </footer>
    </div>
